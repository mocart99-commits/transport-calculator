...
# 5. ВХОДНИ ДАННИ - Обновени цена и стъпка
    ...
    if customer_addr:
        try:
            ...
            if directions:
                ...
                with col_g:
                    google_link = f"http://maps.google.com/maps?saddr={lat},{lng}&daddr={urllib.parse.quote(customer_addr)}&directionsmode=driving"
